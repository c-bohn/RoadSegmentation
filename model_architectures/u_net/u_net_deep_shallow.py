...
def u_net_modified_shallow(pixels_placeholder, is_training_placeholder):
    ...
    #                          strides=1,
    #                          activation=None)
    # if config['use_batch_norm']: conv4 = tf.layers.batch_normalization(conv4, training=is_training)
    ...
    drop5 = tf.keras.layers.SpatialDropout2D(
        0.5, data_format=None)(conv5)  # xx

    # # up6 = Conv2D(512, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
    # #     UpSampling2D(size=(2, 2))(drop5))
    # up6 = tf.layers.conv2d_transpose(inputs=drop5,  # this is not exactly the same as the keras statement above
    #                                  filters=512,
    #                                  kernel_size=[2, 2],
    #                                  padding="same",
    #                                  strides=2,
    ...
    #                          strides=1,
    #                          activation=None)
    # if config['use_batch_norm']: conv6 = tf.layers.batch_normalization(conv6, training=is_training)
    ...
    up7 = tf.layers.conv2d_transpose(inputs=drop5,  # this is not exactly the same as the keras statement above
                                     filters=256,
                                     kernel_size=[2, 2],
                                     padding="same",
                                     strides=2,
